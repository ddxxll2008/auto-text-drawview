...
/**
 * Created by dingxiaolei on 17/2/10.
 */
...
public class DragScaleView extends View implements View.OnTouchListener {
	...
	private interface OnViewSizeChangeListener {
...
//						adjustTvTextSize();
	...
	public OnViewSizeChangeListener getOnViewSizeChangeListener() {
		return onViewSizeChangeListener;
	}
...
//
//		while (textPaintClone.measureText(this.getText().toString()) > this.getWidth()) {
//			trySize--;
